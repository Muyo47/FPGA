...
entity top is
    Port ( 
        ...
        sprite : in std_logic_vector (4-1 downto 0);
...
component fsm_footprint is
  Port ( clk : in std_logic;
         ...
         --pos_x_dbg : in unsigned (10-1 downto 0);
         --pos_y_dbg : in unsigned (10-1 downto 0);
...
component disp is
    Port (
        ...
        sprite_selection : in std_logic_vector (4-1 downto 0);
...
signal reset_gap_phase_cnt : std_logic;
...
signal pos_s : std_logic_vector (20-1 downto 0);
signal mirror_flag_s : std_logic;
signal toggled_mirror_flag_s : std_logic;

signal ent_mux_0_s : std_logic_vector (20-1 downto 0);
signal ent_mux_1_s : std_logic_vector (20-1 downto 0);
...
mux : mux2a1
   Generic map (
       bits_en => 20)
   Port map (
       ent_mux_0 => ent_mux_0_s,
       ent_mux_1 => ent_mux_1_s,
       sel_mux => toggled_mirror_flag_s,
       sal_mux => pos_s
       );
...
maquina_huellas : fsm_footprint
    Port map(
        ...
        clk => clk1_s,
        reset => reset,
        pos_x => unsigned(pos_s(10-1 downto 0)),
        pos_y => unsigned(pos_s(20-1 downto 10)),
...
contador_fila_rom_gap : contador_pasos
    ...
    Port map(
        ...
        max_count => "0000010000"       -- De momento limitamos asi
        --fin_cuenta => trigger_gap_cnt
        );
...
mirror_flagger : biestableT
    Port map (
        clk => clk1_s,
        reset => reset,
        data => mirror_flag_s,
        output_data => toggled_mirror_flag_s,
        enable => '1'
    );
...
reset_gap_cnt <= reset or vblank_flank or mirror_flag_s;
reset_gap_phase_cnt <= reset or vblank_flank or mirror_flag_s or trigger_first_ftprint;
...
------- DEBUG ----------------
ent_mux_0_s <= pos_y (10-1 downto 0) & pos_x (10-1 downto 0);
ent_mux_1_s <= pos_y (20-1 downto 10) & pos_x (20-1 downto 10);
