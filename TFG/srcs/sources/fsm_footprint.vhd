--/======================================================================\
--| Esta maquina de estados gestiona el pintado de huellas               |
--| Dispara una huella unica una vez se alcance las coord. objetivo      |
...
architecture rtl of fsm_footprint is
    ...
    type fsm_huella is (IDLE, pos_all, pos_fil, pos_mirror);
