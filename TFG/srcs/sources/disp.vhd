...
P_pinta: Process (visible, col, fila)
  ...
  sprite_dir <= sprite_selection & std_logic_vector(gap_count_disp(4-1 downto 0));     -- Plano 0
  sprite_dir_2 <= sprite_selection & std_logic_vector(gap_count_disp(4-1 downto 0));     -- Plano 1
